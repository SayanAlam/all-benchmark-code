...
def run_eval(
    ...
    # Delete existing output file if present (start fresh)
    answer_file_path = os.path.expanduser(answer_file)
    ...
    sampling_params = SamplingParams(temperature=0.3, max_tokens=max_new_token, n=num_choices)
    ...
    for question in tqdm(questions):
        ...
        #conv.set_system_message('{"enable_thinking": true}')
...
if __name__ == "__main__":
    ...
    if args.data_mutation: question_file = f"./{args.bench_name}/question_{args.data_mutation}.jsonl"
    else: question_file = f"./{args.bench_name}/question.jsonl"
    if args.answer_file:
